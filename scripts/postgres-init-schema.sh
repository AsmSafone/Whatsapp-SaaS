#!/bin/bash
# Zaptura — built-in PostgreSQL schema init.
#
...
# already-initialized volume, create it manually once (e.g. `CREATE SCHEMA zaptura;`) and set
# POSTGRES_SCHEMA on the zaptura-api service.
set -euo pipefail
