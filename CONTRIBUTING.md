# Contributing to Zaptura

Thanks for your interest in improving Zaptura! This guide covers how to get set up, the
...
Zaptura is a NestJS (backend) + React/Vite (dashboard) project:
...
questions rather than defects in Zaptura. Routing them correctly upfront saves everyone
...
| ------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| Reproducible defect in Zaptura code with clear steps, expected vs. actual | Setup / configuration help ("my proxy doesn't work, how do I configure X?") |
