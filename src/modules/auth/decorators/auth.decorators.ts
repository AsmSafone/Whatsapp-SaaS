...
export const ALLOW_TENANT_SCOPED_CREATE_KEY = 'allowTenantScopedCreate';
...
export const AllowTenantScopedCreate = () => SetMetadata(ALLOW_TENANT_SCOPED_CREATE_KEY, true);
