...
import { looksLikeJwt } from './user-token';
...
export class AuthService implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit(): Promise<void> {
    ...
    this.logger.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    this.logger.log('');
    this.logger.log('  Welcome to Zaptura - WhatsApp API Cloud Gateway');
    this.logger.log('');
  ...
  async validateApiKey(rawKey: string, clientIp?: string, sessionId?: string): Promise<ApiKey> {
    ...
    if (trimmed && looksLikeJwt(trimmed) && this.accountService) {
      const actor = await this.accountService.actorFromToken(trimmed);
      if (actor.allowedSessions && actor.allowedSessions.length > 0 && sessionId) {
        if (!actor.allowedSessions.includes(sessionId)) {
