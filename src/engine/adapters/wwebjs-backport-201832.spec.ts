...
describe('patch-wwebjs-201832 (build-time backport of upstream #201832)', () => {
  ...
  it('applies the backport across every id-normalization site', () => {
    ...
    // Root helper + the load-bearing Message constructor that Zaptura's ~40
    ...
    // from/to/author fallbacks (Zaptura reads these as chat/sender strings).
  ...
  it('normalizes a $1-only id while leaving a healthy id untouched', () => {
    ...
    // Sibling fields survive the copy — Zaptura reads id.remote / id.id downstream.
