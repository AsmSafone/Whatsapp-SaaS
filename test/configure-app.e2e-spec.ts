...
const distDir = join(mkdtempSync(join(tmpdir(), 'zaptura-surface-')), 'dashboard', 'dist');
mkdirSync(distDir, { recursive: true });
writeFileSync(
  join(distDir, 'index.html'),
  `<!doctype html><html><head><meta name="zaptura-csp-nonce" content="${DASHBOARD_CSP_NONCE_PLACEHOLDER}" />` +
