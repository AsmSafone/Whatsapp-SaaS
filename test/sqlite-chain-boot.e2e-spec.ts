...
const dataDb = join(tmpdir(), `zaptura-chain-${process.pid}.sqlite`);
const mainDb = join(tmpdir(), `zaptura-chain-main-${process.pid}.sqlite`);
const keyFile = join(tmpdir(), `zaptura-chain-key-${process.pid}`);
