 ...
 * answers 502 or 504 instead (a plain {@link ZapturaApiError}): the owner may already have carried it
 * out, so do not repeat a non-idempotent send on those unchecked.
 */
public class ZapturaServiceUnavailableError extends ZapturaApiError {
    public ZapturaServiceUnavailableError(String message, int status, Object body, String errorKind) {
