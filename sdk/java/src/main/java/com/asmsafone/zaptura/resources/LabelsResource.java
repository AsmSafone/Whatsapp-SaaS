...
import com.asmsafone.zaptura.model.AddLabelRequest;
import com.asmsafone.zaptura.model.ChatSummary;
import com.asmsafone.zaptura.model.LabelRecord;
import com.asmsafone.zaptura.model.UpsertLabelRequest;
...
public final class LabelsResource {
    ...
    public LabelsResource(ZapturaClient client) {
        this.client = client;
    }
