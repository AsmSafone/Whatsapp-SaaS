...
import com.asmsafone.zaptura.model.ConvertMediaRequest;
import com.asmsafone.zaptura.model.ConvertedMedia;
import com.asmsafone.zaptura.model.MediaConversionAvailability;
...
public final class MediaResource {
    ...
    public MediaResource(ZapturaClient client) {
        this.client = client;
    }
