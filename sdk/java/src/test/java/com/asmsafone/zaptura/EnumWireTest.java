...
import com.asmsafone.zaptura.model.AccountRestrictionKind;
import com.asmsafone.zaptura.model.BatchLifecycleStatus;
import com.asmsafone.zaptura.model.BatchMessageResult;
import com.asmsafone.zaptura.model.BatchMessageStatus;
import com.asmsafone.zaptura.model.ChatHistoryMessage;
import com.asmsafone.zaptura.model.ChatKind;
import com.asmsafone.zaptura.model.MemberAddMode;
import com.asmsafone.zaptura.model.MessageType;
import com.asmsafone.zaptura.model.PresenceState;
import com.asmsafone.zaptura.model.SessionResponse;
import com.asmsafone.zaptura.model.SessionStatus;
...
class EnumWireTest {
    ...
    void batchPresenceRestrictionAndMemberAddModeRoundTrip() {
        ...
        com.asmsafone.zaptura.model.BatchStatusResponse s = gson.fromJson(
            "{\"batchId\":\"b1\",\"status\":\"processing\",\"progress\":{\"total\":1,\"sent\":0,"
                + "\"failed\":0,\"pending\":1,\"cancelled\":0},\"results\":[]}",
            com.asmsafone.zaptura.model.BatchStatusResponse.class);
        assertEquals(BatchLifecycleStatus.PROCESSING, s.status());

        com.asmsafone.zaptura.model.ParticipantPresence p = gson.fromJson(
            "{\"id\":\"628@c.us\",\"state\":\"recording\"}",
            com.asmsafone.zaptura.model.ParticipantPresence.class);
        assertEquals(PresenceState.RECORDING, p.state());

        com.asmsafone.zaptura.model.AccountRestriction a = gson.fromJson(
            "{\"kind\":\"proxy_block\",\"code\":\"X\"}",
            com.asmsafone.zaptura.model.AccountRestriction.class);
        assertEquals(AccountRestrictionKind.PROXY_BLOCK, a.kind());

        com.asmsafone.zaptura.model.GroupInfo g = gson.fromJson(
            "{\"id\":\"g\",\"name\":\"n\",\"memberAddMode\":\"admins\"}",
            com.asmsafone.zaptura.model.GroupInfo.class);
