...
use Zaptura\Exceptions\ZapturaAuthException;
...
class ClientTest extends TestCase
{
    ...
    {
        $this->expectException(\Zaptura\Exceptions\ZapturaException::class);
        new \Zaptura\Client(['baseUrl' => '', 'apiKey' => 'k']);
    }

    public function testRequiresApiKey(): void
    {
        $this->expectException(\Zaptura\Exceptions\ZapturaException::class);
        new \Zaptura\Client(['baseUrl' => 'https://x', 'apiKey' => '']);
    }
    ...
    public function test401MapsToAuthException(): void
    {
        ...
        $this->expectException(ZapturaAuthException::class);
        $backend->makeClient()->sessions->list();
    }
    ...
    public function testTimeoutWithErrno28MapsToTimeoutException(): void
    {
        ...
        // ZapturaTimeoutException, regardless of the message wording.
        ...
        $this->expectException(ZapturaTimeoutException::class);
        $client->sessions->list();
    }
