...
if (typeof cjs.ZapturaClient !== 'function') throw new Error('CJS: ZapturaClient missing');

const esm = await import(new URL('../dist/esm/index.js', import.meta.url).href);
if (typeof esm.ZapturaClient !== 'function') throw new Error('ESM: ZapturaClient missing');
...
console.log('smoke OK: require() + import() both resolve ZapturaClient, and each condition types itself');
