...
// Wire types for the Zaptura API, split by domain into types_*.go files. Field
...
//
//	zaptura.DeleteMessageRequest{ChatID: id, MessageID: mid, ForEveryone: zaptura.Ptr(false)}
